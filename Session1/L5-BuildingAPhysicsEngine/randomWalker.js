...
const sliders = {
  ...
  acceleration: createSlider(-50, 50, DEFAULT_ACCELERATION, 1),
};
...
class Walker {
  ...
  //Walking method
  walk() {
    //This is not ok, this is working as a velocity :c
    //A negative acceleration should stop the elements (?)
    this.acceleration = createVector(
      sliders.acceleration.value(),
      sliders.acceleration.value()
    );

    this.velocity.add(this.acceleration);

    //Add randomness to the direcction
